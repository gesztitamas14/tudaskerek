...
Az egyjátékos mód adatbázis **nélkül is** teljesen működik (5827 beépített
...
node tools/src/import-seed.mjs        # 5827 kérdés
```
...
| Supabase DB | 500 MB | ~50 000 kérdés (most 5827 ≈ 2 MB) |
