...
Az egyjátékos mód adatbázis **nélkül is** teljesen működik (2125 beépített
...
node tools/src/import-seed.mjs        # 2125 kérdés
```
...
| Supabase DB | 500 MB | ~50 000 kérdés (most 2125 ≈ 2 MB) |
