...
|---|---|---|---|
| **Statikus fájlok** (`web/`) | HTML, CSS, JS, ikonok, 2236 kérdés | GitHub Pages | 0 Ft |
...
**Fontos:** a játék az adatbázis nélkül is teljesen működik (offline mód, 2236
...
aloldalról kiszolgálva ugyanúgy betölti mind a 2236 kérdést.
...
node tools/src/import-seed.mjs             # 28 kategória + 2236 kérdés
```
