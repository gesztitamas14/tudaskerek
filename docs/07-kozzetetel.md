...
|---|---|---|---|
| **Statikus fájlok** (`web/`) | HTML, CSS, JS, ikonok, 2135 kérdés | GitHub Pages | 0 Ft |
...
**Fontos:** a játék az adatbázis nélkül is teljesen működik (offline mód, 2135
...
aloldalról kiszolgálva ugyanúgy betölti mind a 2135 kérdést.
...
node tools/src/import-seed.mjs             # 28 kategória + 2135 kérdés
```
