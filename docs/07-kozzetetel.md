...
|---|---|---|---|
| **Statikus fájlok** (`web/`) | HTML, CSS, JS, ikonok, 5827 kérdés | GitHub Pages | 0 Ft |
...
**Fontos:** a játék az adatbázis nélkül is teljesen működik (offline mód, 5827
...
aloldalról kiszolgálva ugyanúgy betölti mind a 5827 kérdést.
...
node tools/src/import-seed.mjs             # 28 kategória + 5827 kérdés
```
